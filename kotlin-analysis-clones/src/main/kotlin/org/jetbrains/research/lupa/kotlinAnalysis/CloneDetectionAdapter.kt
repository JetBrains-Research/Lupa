...
object CloneDetectionAdapter {
    ...
    fun format(
        ...
        val tokens: List<String> =
            org.jetbrains.research.lupa.kotlinAnalysis.CloneDetectionAdapter.tokenize(function.text)
        val totalTokens = tokens.size
        val tokensCounter: Map<String, Int> = tokens.groupingBy { it }
            .eachCount()
        val uniqueTokens = tokensCounter.keys.size
        val hash: String = org.jetbrains.research.lupa.kotlinAnalysis.CloneDetectionAdapter.md5Hash(function.text)
