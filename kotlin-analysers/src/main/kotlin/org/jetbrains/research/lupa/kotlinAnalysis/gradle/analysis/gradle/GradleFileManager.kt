...
import org.jetbrains.research.lupa.kotlinAnalysis.gradle.analysis.gradle.buildGradle.BuildGradleGroovyPsiFile
import org.jetbrains.research.lupa.kotlinAnalysis.gradle.analysis.gradle.buildGradle.BuildGradleKtsPsiFile
import org.jetbrains.research.lupa.kotlinAnalysis.gradle.analysis.gradle.buildGradle.BuildGradlePsiFile
import org.jetbrains.research.lupa.kotlinAnalysis.gradle.analysis.gradle.gradleProperties.GradlePropertiesPsiFile
import org.jetbrains.research.lupa.kotlinAnalysis.gradle.analysis.gradle.settingsGradle.SettingsGradleGroovyPsiFile
import org.jetbrains.research.lupa.kotlinAnalysis.gradle.analysis.gradle.settingsGradle.SettingsGradleKtsPsiFile
import org.jetbrains.research.lupa.kotlinAnalysis.gradle.analysis.gradle.settingsGradle.SettingsGradlePsiFile
import org.jetbrains.research.lupa.kotlinAnalysis.psi.extentions.extractPsiFiles
import org.jetbrains.research.lupa.kotlinAnalysis.psi.extentions.findPsiFile
import org.jetbrains.research.lupa.kotlinAnalysis.psi.extentions.findPsiFileByName
    ...
    companion object {
        ...
        fun extractBuildGradleFileFromModule(module: Module): BuildGradlePsiFile? {
            return extractGradleFileFromModule(
                ...
                Companion::toBuildGradlePsiFile
            )
        }
        ...
        fun extractSettingsGradleFileFromModule(module: Module): SettingsGradlePsiFile? {
            return extractGradleFileFromModule(
                ...
                Companion::toSettingsGradlePsiFile
            )
        }
